#!/bin/sh
 erzuzh/raiwei
# configs
AUUID=2648e9b0-ee03-49a0-802a-da01a790f07f
CADDYIndexPage=https://github.com/PavelDoGreat/WebGL-Fluid-Simulation/archive/master.zip
CONFIGCADDY=https://raw.githubusercontent.com/erzuzh/raiwei/master/etc/Caddyfile
CONFIGXRAY=https://raw.githubusercontent.com/erzuzh/raiwei/master/etc/xray.json
